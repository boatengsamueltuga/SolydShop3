...
//    }
    ...
    // Updating because of backend requirements
    @GetMapping("/public/products")
    public ResponseEntity<ProductResponse> getAllProducts(
   ...
   //Admin Product Update
    ...
    //@PutMapping("/products/{productId}/image") admin was added this api because
    //Only Admin will have access to it
    ...
    //Backend API for Admin Product Fetching
    ...
    //Below is the Backend API for Seller Product Fetching and other related  APIs
